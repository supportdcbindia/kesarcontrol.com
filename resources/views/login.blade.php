...
<head>
  ...
  <title>Kesar Control Login</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="{{url('/admin/post-login')}}" method="post"> @csrf
              ...
              <div class="credits">
                ...
                Designed by <a href="https://pleximusinc.com/">Pleximusinc.com</a>
              </div>
